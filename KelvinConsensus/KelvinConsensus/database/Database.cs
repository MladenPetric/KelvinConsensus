...
public class SensorDatabse
{
    private readonly string _connectionString;

    public SensorDatabse(SensorName name)
    {
        string sensorName = GetConnectionName(name);
    ...
    private string GetConnectionName(SensorName name)
    {
        return sensorName switch
        {
            sensorName.Sensor1 => "Sensor1",
            sensorName.Sensor2 => "Sensor2",
            sensorName.Sensor3 => "Sensor3",
            _ => throw new ArgumentOutOfRangeException(nameof(sensorType), "Unknown sensor")
        };
    }
